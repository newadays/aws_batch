...
* A word count example using map reduce on AWS Batch with docker to count words in a large body of text e.g. [moby dick](https://en.wikipedia.org/wiki/Moby-Dick).
